...
<head>
    ...
    <title>{{ config('app.nam', 'Electrodomesticos Nuñez') }}</title>
        ...
        <nav class="bg-gray-800">
          <div class="container mx-auto px-4 flex items-center justify-between">
            <a class=" text-4xl font-bold text-white" href="{{ url('/') }}">
              {{ config('app.nam', 'Electrodomesticos Nuñez') }}
            </a>
              ...
              <ul class="space-x-4">
                ...
                @else
                  <li class="relative">
                    ...
                    <div class="right-0 mt-2 bg-gray-800 shadow-lg rounded w-48" aria-labelledby="navbarDropdown">
